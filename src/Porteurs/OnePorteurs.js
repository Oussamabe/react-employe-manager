...
export default class OnePorteurs extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            por_NOM : this.props.match.params.por_NOM,
            porteurs: {}
        }
    }

    componentDidMount(){
        PorteurService.searchPorteurs(this.state.cmp_RIB , this.state.por_NOM).then(res => {
